...
#RecursionError: maximum recursion depth exceeded
 ...
 #Hint: Your func_adder should return two arguments func and func_adder. 
 #What function do we know that returns func and func_adder?
#        return func, func_adder
...
def missing_digits(n):
    ...
    if n<10:
        ...
        if last==second:
            ...
            sum=last-second-1
            return missing_digits(n//10)+sum
...
def count_change(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def count_helper(total, small_point):#需要跟踪其中的某些参数的时候，需要helper function
        if total==1 or total==0:
            return 1
        elif total==small_point:
            return 1
        elif total<small_point:
            return 0
        elif total%small_point!=0:
            return 0
        else:
            return count_helper(total-small_point, small_point)+count_helper(total, 2*small_point)     
            #一部分是包含最小值，一部分不包含最小值，即*2
